      ...
      <div className="fixed bottom-6 right-6 z-50 w-80 h-96 bg-card border rounded-xl shadow-lg flex flex-col animate-in fade-in slide-in-from-bottom-2 duration-200">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            <p className="font-medium text-sm">Canlı Destek</p>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <div className="bg-muted rounded-lg p-3 max-w-[80%]">
            ...
            <p className="text-xs text-muted-foreground mt-1">Müşteri Temsilcisi</p>
          </div>
        </div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="text-left">
                <p className="text-sm font-medium">Canlı Destek</p>
                <p className="text-xs text-muted-foreground">Şimdi çevrimiçi</p>
              </div>
            </button>
