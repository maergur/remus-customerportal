          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-card rounded-2xl p-5 border border-border">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-muted-foreground">Geçen Ay</span>
              </div>
              <p className="text-2xl font-bold text-foreground">278 kWh</p>
            ...
            <div className="bg-card rounded-2xl p-5 border border-border">
              ...
              <p className="text-2xl font-bold text-foreground">3,100 kWh</p>
            ...
            <div className="bg-card rounded-2xl p-5 border border-border">
              ...
              <p className="text-2xl font-bold text-foreground">258 kWh</p>
