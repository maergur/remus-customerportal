...
const Register = () => {
  ...
  return (
    <AuthLayout
      heroImage={greenEnergyRegister}
      heroImageAlt="Sürdürülebilir Gelecek"
              ...
              <form onSubmit={handleSetPassword} className="space-y-4">
                ...
                <div className="space-y-1">
                  {[{
                    ...
                    <div key={i} className={`text-xs flex items-center gap-1.5 ${req.valid ? 'text-primary' : 'text-muted-foreground'}`}>
