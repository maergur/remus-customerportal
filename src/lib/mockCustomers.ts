...
export const mockExistingCustomers: MockCustomer[] = [
  ...
  },
  {
    id: '8',
    phone: '5364445566',
    email: 'hande@remusenerji.com',
    fullName: 'Hande Remus',
    customerNumber: 'MUS000005',
    hasPassword: true,
    password: 'test123',
  },
  {
    id: '9',
    phone: '5375556677',
    email: 'hakan@remusenerji.com',
    fullName: 'Hakan Remus',
    customerNumber: 'MUS000006',
    hasPassword: true,
    password: 'test123',
  },
  {
    id: '10',
    phone: '5386667788',
    email: 'onur@remusenerji.com',
    fullName: 'Onur Remus',
    customerNumber: 'MUS000007',
    hasPassword: true,
    password: 'test123',
  },
];
...
const customerPasswords: Record<string, string> = {
  ...
  '8': 'test123', // Hande already has a password
  '9': 'test123', // Hakan already has a password
  '10': 'test123', // Onur already has a password
};
